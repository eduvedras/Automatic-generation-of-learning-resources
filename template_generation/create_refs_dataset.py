# iterar refs_dataset adicionar nova coluna e escolher uma questão por template para por lá compparando com o TemplatesFinal
import pandas as pd
import random
from tqdm import tqdm

questions = pd.read_csv('QuestionsDataset.csv',sep=';')

templates = pd.read_csv('TemplatesFinal.csv',sep=';')
...
new_data.to_csv('refs_dataset1.csv', sep=";",index=False)
qa_dataset.to_csv('qa_dataset.csv', sep=";",index=False)
